...
export default function topicReducer(state = initialState.topic, action) {
  switch (action.type) {
    ...
    case types.SET_CAUSES:
      return Object.assign({}, state, { isFetching: false, _sourceCauses: action.payload });
    
    case types.SET_EFFECTS:
        return Object.assign({}, state, { isFetching: false, _sourceEffects: action.payload });
    ...
    case types.SET_SUB_CAUSES:
      ...
      return Object.assign({}, state, { isFetching: false, activeIndex: action.idx, causes });
    ...
    case types.SET_SUB_EFFECTS:
      ...
      return Object.assign({}, state, { isFetching: false, activeIndex: action.idx, effects });
